---
name: tilly-adapter
description: Use when the user says /tilly:adapter or asks to materialize, install, dry-run, retrofit, validate, or certify Codex, Claude, Cursor, or all Tilly adapters.
---

# Tilly Adapter

`/tilly:adapter` is the shortcut for adapter materialization, dry-run install,
