...
needed to match the documented primary command without splitting routed aliases
such as `/tes-update` and `/tes-curate` into unnecessary skills.
...
|--------|-------|-------------|---------|
| 2026-05-11 | `tes-field-reports` skill route | 0 before creation | Missing visible Codex skill. |
