---
name: tilly-bench
description: Use when the user says /tilly:bench or asks to plan, run, converge, inspect, or certify Tilly context-mesh benchmarks and behavior evidence.
license: MIT
---

# Tilly Bench

`/tilly:bench` is the shortcut for benchmark planning, fixture runs, convergence
