---
name: tilly-doctor
description: Use when the user says /tilly:doctor, /tilly:check, /tilly:certify, or asks to validate, health-check, certify, or prepare a Tilly Engineer Skills commit.
license: MIT
---

# Tilly Doctor

`/tilly:doctor` is the shortcut for package and mesh health checks. Use
`/tilly:check` and `/tilly:certify` as aliases.
