...
8. When the optional OmniVoice provider is already configured by the
   ...
   command writes `result.json` and `review.html` beside the generated WAV
   files. Reopen the latest review with
   `python3 scripts/tes_tts_omnivoice_provider.py review`.
