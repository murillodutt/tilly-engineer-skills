...
- 2026-05-13T00:00:00Z `FRAMED`: Target canary
  `/Users/murillo/Dev/cellm-private`; TES baseline
...
- First failure observed: `python3 scripts/project_alignment_oracle.py --target
  /Users/murillo/Dev/cellm-private` failed with `todo` and `run tests` in
...
- 2026-05-13T00:00:00Z `ORIGINAL_RETESTED`: `python3
  scripts/project_alignment_oracle.py --target /Users/murillo/Dev/cellm-private`
...
four_d_scan:
  ...
  verification: >
    ...
    /Users/murillo/Dev/cellm-private; npm run commit:check
  decay: >
...
build_test_fail_fix:
  ...
  target: /Users/murillo/Dev/cellm-private
  baseline:
  ...
  exact_retest: >
    python3 scripts/project_alignment_oracle.py --target
    /Users/murillo/Dev/cellm-private -> PASS
  related_gates:
