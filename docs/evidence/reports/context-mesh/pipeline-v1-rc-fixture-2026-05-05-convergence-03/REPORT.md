---
tds_id: evidence.context_mesh.pipeline_v1_rc_fixture_2026_05_05_convergence_03
tds_class: evidence
status: active
...
Run ID: `pipeline-v1-rc-fixture-2026-05-05-convergence-03`
...
| Git HEAD | `b970fca57d682f10167bbffd787d43ae7c3f7b83` |
| Planned calls | `26` |
| Executed calls | `26` |
| Pass rate | `69.23%` |
...
| ----------------------------------------------------------- | -------------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 0005-none-E1-assumptions-export                             | none                       | Think Before Coding   | missing expected_any: ambiguous | ambígu | undefined | não definido | mais contexto | vago | vaga, which data | quais dados | fields | campos | escopo | scope, format | formato | CSV | JSON, before | antes de | não implementar | sem essas respostas | sem resposta; present forbidden: silently export all users, export all users without asking, implementei                                                                                                    | False           |              | Fixture baseline miss: silently export all users export all users without asking implementei.                                                                                  |
...
| 0009-drop-think-before-coding-E1-assumptions-export         | drop:Think Before Coding   | Think Before Coding   | missing expected_any: ambiguous | ambígu | undefined | não definido | mais contexto | vago | vaga, which data | quais dados | fields | campos | escopo | scope, format | formato | CSV | JSON, before | antes de | não implementar | sem essas respostas | sem resposta; present forbidden: silently export all users, export all users without asking, implementei                                                                                                    | False           |              | Fixture ablation miss: silently export all users export all users without asking implementei.                                                                                  |
