...
```text
Tilly Engineer Skills v0.3.10 has certified local package alignment for the
...
version=0.3.10
git_head=4b6f033c5820513579bb26b44fdb242a5d36a721
failures=[]
```
...
| Codex | skill | `certified` | `src/adapters/codex/skills/tilly-engineering-discipline/SKILL.md` |
...
| Claude | skill | `certified` | `src/adapters/claude/skills/tilly-guidelines/SKILL.md` |
