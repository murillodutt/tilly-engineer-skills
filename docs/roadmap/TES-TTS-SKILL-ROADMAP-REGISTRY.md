...
| `scripts/tes_tts_omnivoice_provider.py` | Optional OmniVoice status, speak, bench, review, package-review, probe, synthesize, normalize-ref, and batch facade. | active |
