...
| `docs/roadmap/GOAL-PROMPT-tes-tts-RTO-004-direct-kernel-boundary-hardening.md` | Next circular execution prompt for direct kernel boundary hardening. | active |
