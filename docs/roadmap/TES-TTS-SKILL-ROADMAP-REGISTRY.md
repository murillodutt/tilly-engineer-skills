...
| `scripts/tes_tts_omnivoice_provider.py` | Optional OmniVoice status, product-status JSON/text/strict cockpit, speak, bench, review, decide-review, package-review, probe, synthesize, normalize-ref, and batch facade. | active |
