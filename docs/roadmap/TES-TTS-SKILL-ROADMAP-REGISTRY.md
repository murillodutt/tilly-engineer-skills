...
| `scripts/tes_tts_omnivoice_provider.py` | Optional OmniVoice status, warm-cache, resident session, latency profiles, profile-review recommendation, product-status cockpit, candidate replay/open cockpit, speak, bench, review, decide-review, package-review, probe, synthesize, normalize-ref, and batch facade. | active |
...
| `docs/roadmap/TES-TTS-SKILL-ROADMAP.md` | Current dashboard and next decisions. | active |
