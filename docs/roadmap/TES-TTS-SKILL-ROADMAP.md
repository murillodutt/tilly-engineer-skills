...
| `docs/roadmap/GOAL-SUPER-SPEC-tes-tts-lexical-runtime-engine-latency-reduction.md` | Runtime engine and latency reduction contract; ready prompt is RTE-004. | active |
...
The current TTS execution contract is `docs/roadmap/GOAL-SUPER-SPEC-tes-tts-lexical-runtime-engine-latency-reduction.md`; ready prompt: `docs/roadmap/GOAL-PROMPT-tes-tts-RTE-004-request-local-memoization.md`.
...
Runtime latency status: RTE-003 passed with fast-path spoken-rendering fixtures/oracle; RTE-004 ready prompt created for request-local memoization.
