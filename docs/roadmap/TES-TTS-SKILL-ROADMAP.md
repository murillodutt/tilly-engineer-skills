...
| `docs/roadmap/GOAL-SUPER-SPEC-tes-tts-lexical-runtime-engine-latency-reduction.md` | Runtime engine and latency reduction contract; ready prompt is RTE-002. | active |
...
The current TTS execution contract is `docs/roadmap/GOAL-SUPER-SPEC-tes-tts-lexical-runtime-engine-latency-reduction.md`; ready prompt: `docs/roadmap/GOAL-PROMPT-tes-tts-RTE-002-hot-path-span-matcher.md`.
...
Runtime latency status: RTE-001 passed with compiled lexical index fixtures/oracle; RTE-002 ready prompt created for hot-path span matching.
