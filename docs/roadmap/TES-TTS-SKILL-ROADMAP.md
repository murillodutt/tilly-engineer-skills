...
| `docs/roadmap/GOAL-SUPER-SPEC-tes-tts-lexical-runtime-engine-latency-reduction.md` | Runtime engine and latency reduction contract; ready prompt is RTE-003. | active |
...
The current TTS execution contract is `docs/roadmap/GOAL-SUPER-SPEC-tes-tts-lexical-runtime-engine-latency-reduction.md`; ready prompt: `docs/roadmap/GOAL-PROMPT-tes-tts-RTE-003-fast-path-spoken-rendering.md`.
...
Runtime latency status: RTE-002 passed with hot-path span matcher fixtures/oracle; RTE-003 ready prompt created for fast-path spoken rendering.
