...
Each non-closed unit must update `docs/roadmap/tes-tts/TES-TTS-SKILL-ROADMAP.md` and
...
`docs/roadmap/tes-tts/TES-TTS-RTE-006-RUNTIME-AUDIT-AND-CLOSURE.md`. Closure does not
