...
3. Re-read:
   ...
   - `docs/roadmap/goals/prompts/tes-tts/GOAL-PROMPT-tes-tts-CAP-004-provider-fallback-catalog-use.md`
...
11. Update `docs/roadmap/tes-tts/TES-TTS-SKILL-ROADMAP.md` with CAP-004 outcome,
