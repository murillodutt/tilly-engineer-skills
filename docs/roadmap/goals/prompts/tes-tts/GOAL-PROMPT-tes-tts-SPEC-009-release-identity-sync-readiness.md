...
Status note: archived after SPEC-009. Next ready prompt:
...
3. Re-read:
   - `docs/roadmap/goals/super-specs/GOAL-SUPER-SPEC-tes-tts-ten-spec-convergence.md`
   - `docs/roadmap/tes-tts/TES-TTS-SPEC-009-release-identity-sync-readiness.md`
...
8. Create or update the next `/goal` prompt for SPEC-010 Final Audit And
   ...
   decision prompt.
9. Update `docs/roadmap/tes-tts/TES-TTS-SKILL-ROADMAP.md` with SPEC-009 outcome,
