...
2. Re-read:
   - `docs/roadmap/tes-tts/TES-TTS-RUNTIME-PYTHON-OPTIMIZATION-AUDIT.md`
   - `docs/roadmap/goals/prompts/tes-tts/GOAL-PROMPT-tes-tts-RTO-004-direct-kernel-boundary-hardening.md`
...
8. Update `docs/roadmap/tes-tts/TES-TTS-SKILL-ROADMAP.md` with RTO-005 outcome,
