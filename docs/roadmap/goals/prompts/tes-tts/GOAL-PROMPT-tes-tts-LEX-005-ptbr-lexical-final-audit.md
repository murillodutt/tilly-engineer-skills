...
3. Re-read:
   - `docs/roadmap/goals/super-specs/GOAL-SUPER-SPEC-tes-tts-ptbr-lexical-normalization.md`
   - `docs/roadmap/tes-tts/TES-TTS-LEX-001-PTBR-LEXICAL-DATASET-MANIFEST.md`
   - `docs/roadmap/tes-tts/TES-TTS-LEX-002-PTBR-LEXICAL-LOOKUP-ORACLE.md`
   - `docs/roadmap/tes-tts/TES-TTS-LEX-003-SPOKEN-RENDERING-INTEGRATION-BOUNDARY.md`
   - `docs/roadmap/tes-tts/TES-TTS-LEX-004-FIXTURE-MIGRATION-FROM-MARKDOWN-SHAPED-TTS-CASES.md`
...
8. Update `docs/roadmap/tes-tts/TES-TTS-SKILL-ROADMAP.md` with LEX-005 outcome,
