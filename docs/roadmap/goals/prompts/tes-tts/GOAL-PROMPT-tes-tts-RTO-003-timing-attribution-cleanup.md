...
2. Re-read:
   - `docs/roadmap/tes-tts/TES-TTS-RUNTIME-PYTHON-OPTIMIZATION-AUDIT.md`
   - `docs/roadmap/goals/prompts/tes-tts/GOAL-PROMPT-tes-tts-RTO-002-provider-oracle-partition.md`
...
8. Update `docs/roadmap/tes-tts/TES-TTS-SKILL-ROADMAP.md` with RTO-003 outcome,
