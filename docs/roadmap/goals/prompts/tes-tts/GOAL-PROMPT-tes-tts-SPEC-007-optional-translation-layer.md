...
Status note: archived after SPEC-007. Next ready prompt:
...
3. Re-read:
   - `docs/roadmap/goals/super-specs/GOAL-SUPER-SPEC-tes-tts-ten-spec-convergence.md`
   - `docs/roadmap/tes-tts/TES-TTS-SPEC-007-optional-translation-layer.md`
...
9. Update `docs/roadmap/tes-tts/TES-TTS-SKILL-ROADMAP.md` with SPEC-007 outcome,
