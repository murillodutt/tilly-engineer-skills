...
This folder preserves roadmap lineage without turning the roadmap into the work. Current package baseline: TES `0.3.216`. Execution authority lives in the current dashboard, Super SPEC, audit record, or runtime oracle for each line.
