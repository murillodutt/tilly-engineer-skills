...
work. Current package baseline: TES `0.3.160`. Execution authority lives in the
...
| TES attach/detach and attach-health | Proposed | `goals/super-specs/GOAL-SUPER-SPEC-tes-attach-detach-and-attach-health.md` |
