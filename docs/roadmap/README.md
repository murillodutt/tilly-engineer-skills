...
work. Current package baseline: TES `0.3.165`. Execution authority lives in the
...
| TES bootloader-to-skill migration | Proposed | `goals/super-specs/GOAL-SUPER-SPEC-tes-bootloader-skill-migration.md` |
