...
3. Re-read:
   ...
   - `docs/roadmap/TES-TTS-SPEC-001-roadmap-compaction-agent-default-language.md`
     through `docs/roadmap/TES-TTS-SPEC-009-release-identity-sync-readiness.md`
...
8. If the approved scope is complete, close convergence with a final audit
   ...
   decision.
9. Update `docs/roadmap/TES-TTS-SKILL-ROADMAP.md` with SPEC-010 outcome,
