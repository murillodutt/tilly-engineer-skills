...
| Item | Value |
|------|-------|
| Package version | `0.3.142` |
| Latest certified line | ADR 0001 memory lifecycle plus ADR 0002 governed MCP remember, postinstall/Cortex curation hardening, and clean `0.3.142` bundle metadata |
