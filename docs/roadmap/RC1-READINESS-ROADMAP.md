...
| Item | Value |
|------|-------|
| Package version | `0.3.134` |
| Latest certified line | ADR 0001 memory lifecycle local package-source closure, clean `0.3.134` bundle metadata, and one neutral canary replay |
