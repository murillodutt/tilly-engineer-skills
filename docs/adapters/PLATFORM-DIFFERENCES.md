...
| Materialize maestral goal | `/tes-goal-maestro` | `/tes:goal-maestro` | Generate an execution-grade materialization tree and, after acceptance, a maestral `/goal` prompt from a mature SPEC. |
