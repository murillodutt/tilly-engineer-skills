...
`#v0.3.104` is the fixed release ref and the supported commercial install path.
...
TES_GITHUB_NPX_REF=v0.3.104 python3 scripts/tes_npx_oracle.py --github-self-test
```
