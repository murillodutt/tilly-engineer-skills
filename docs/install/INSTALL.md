...
after a fixed ref is authorized and release-certified. The current `0.3.135`
...
```bash
npx --loglevel=error -y --package github:murillodutt/tilly-engineer-skills#v0.3.135 tilly-engineer-skills add
```

```bash
bunx --silent --bun --package github:murillodutt/tilly-engineer-skills#v0.3.135 tilly-engineer-skills add
```
...
```bash
npx --loglevel=error -y --package github:murillodutt/tilly-engineer-skills#v0.3.135 tilly-engineer-skills add --agent all --yes
```

`#v0.3.135` is the intended fixed-ref form for a release-certified install
