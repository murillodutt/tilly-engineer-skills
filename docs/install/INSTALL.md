...
Current `0.3.146` evidence is local package-source and bundle closure; it does not authorize remote tag, release, package publish, or marketplace action.
...
```bash
npx --loglevel=error -y --package github:murillodutt/tilly-engineer-skills#v0.3.146 tilly-engineer-skills add
```

```bash
bunx --silent --bun --package github:murillodutt/tilly-engineer-skills#v0.3.146 tilly-engineer-skills add
```
...
```bash
npx --loglevel=error -y --package github:murillodutt/tilly-engineer-skills#v0.3.146 tilly-engineer-skills add --agent all --yes
```

`#v0.3.146` is the intended fixed-ref form for a release-certified install
