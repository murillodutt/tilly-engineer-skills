...
```bash
npx --loglevel=error -y --package github:murillodutt/tilly-engineer-skills#v0.3.124 tilly-engineer-skills add
```

```bash
bunx --silent --bun --package github:murillodutt/tilly-engineer-skills#v0.3.124 tilly-engineer-skills add
```
...
```bash
npx --loglevel=error -y --package github:murillodutt/tilly-engineer-skills#v0.3.124 tilly-engineer-skills add --agent all --yes
```

`#v0.3.124` is the fixed release ref and supported commercial install path; do not certify mutable release refs without their own canary evidence.
