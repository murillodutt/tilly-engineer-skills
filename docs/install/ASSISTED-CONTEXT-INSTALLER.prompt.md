...
- `source_freshness`: `PASS` when both commits are known and equal, `STALE_SOURCE` when both are known and differ, or `BLOCKED` when freshness cannot be checked.
