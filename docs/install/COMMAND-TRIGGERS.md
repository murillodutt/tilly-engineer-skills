...
| `npx --loglevel=error -y --package github:murillodutt/tilly-engineer-skills#v0.3.185 tilly-engineer-skills add` | fixed GitHub npx installer entrypoint |
...
- Do not give `/tes-prospect`, `/tes-mine`, or `/tes-goal-maestro` broad
  ...
  worker subagent, require local commit evidence, keep push forbidden, and run
  Executive Stop Audit before final closure. If both handoff and
