...
| `npx --loglevel=error -y --package github:murillodutt/tilly-engineer-skills#v0.3.223 tilly-engineer-skills add` | fixed GitHub npx installer entrypoint |
