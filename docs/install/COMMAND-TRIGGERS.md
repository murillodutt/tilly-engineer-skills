...
- Do not give `/tes-prospect`, `/tes-mine`, or `/tes-goal-maestro` broad
  ...
  `SPEC_REPAIR_BY_LLM`, owner-approved cloud redaction, bounded audit repairs,
  and branch statuses such as `NEEDS_MORE_LOOPS`, `NEEDS_OWNER_DECISION` and
  `SAFETY_BLOCKED`.
