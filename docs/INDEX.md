...
| TES TTS TTS-004 ready goal prompt | `roadmap/GOAL-PROMPT-tes-tts-TTS-004-fixture-corpus.md` |
...
| TES TTS TTS-013 ready goal prompt | `roadmap/GOAL-PROMPT-tes-tts-TTS-013-owner-decision-pending.md` |
...
| TES TTS TTS-018 ready goal prompt | `roadmap/GOAL-PROMPT-tes-tts-TTS-018-owner-decision-unresolved.md` |
| TES TTS TTS-019 ready goal prompt | `roadmap/GOAL-PROMPT-tes-tts-TTS-019-owner-decision-still-unresolved.md` |
...
| TES TTS TTS-024 ready goal prompt | `roadmap/GOAL-PROMPT-tes-tts-TTS-024-owner-decision-still-unresolved-again.md` |
| TES TTS TTS-025 ready goal prompt | `roadmap/GOAL-PROMPT-tes-tts-TTS-025-owner-decision-continues-unresolved-again.md` |
| TES TTS TTS-026 ready goal prompt | `roadmap/GOAL-PROMPT-tes-tts-TTS-026-owner-decision-remains-unresolved-again.md` |
| TES TTS TTS-027 ready goal prompt | `roadmap/GOAL-PROMPT-tes-tts-TTS-027-owner-decision-still-remains-unresolved-again.md` |
...
| TES TTS LEX-003 spoken-rendering integration boundary | `roadmap/TES-TTS-LEX-003-SPOKEN-RENDERING-INTEGRATION-BOUNDARY.md` |
| TES TTS LEX-003 historical goal prompt | `roadmap/GOAL-PROMPT-tes-tts-LEX-003-spoken-rendering-integration-boundary.md` |
| TES TTS LEX-004 ready goal prompt | `roadmap/GOAL-PROMPT-tes-tts-LEX-004-fixture-migration-from-markdown-shaped-tts-cases.md` |
...
| TES TTS explicit owner decision | `roadmap/TES-TTS-EXPLICIT-OWNER-DECISION.md` |
...
| TES TTS owner decision open | `roadmap/TES-TTS-OWNER-DECISION-OPEN.md` |
| TES TTS owner decision unresolved | `roadmap/TES-TTS-OWNER-DECISION-UNRESOLVED.md` |
...
| TES TTS owner decision unresolved again | `roadmap/TES-TTS-OWNER-DECISION-UNRESOLVED-AGAIN.md` |
| TES TTS owner decision still unresolved again | `roadmap/TES-TTS-OWNER-DECISION-STILL-UNRESOLVED-AGAIN.md` |
| TES TTS owner decision continues unresolved again | `roadmap/TES-TTS-OWNER-DECISION-CONTINUES-UNRESOLVED-AGAIN.md` |
| TES TTS owner decision remains unresolved again | `roadmap/TES-TTS-OWNER-DECISION-REMAINS-UNRESOLVED-AGAIN.md` |
...
| TES TTS owner decision remains open yet again | `roadmap/TES-TTS-OWNER-DECISION-REMAINS-OPEN-YET-AGAIN.md` |
