...
def analyze() -> dict[str, Any]:
    ...
    surface("codex", "plugin", "deferred", "Codex plugins are native, but TES v0.3.48 ships local skills first.")
    ...
    surface("cursor", "skill", "deferred", "Cursor plugin skills exist officially, but TES v0.3.48 ships Cursor rules first.")
