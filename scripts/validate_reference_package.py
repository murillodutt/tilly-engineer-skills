...
REQUIRED_PATHS = (
    ...
    "docs/dist/0.3.255/index.json",
    "docs/dist/0.3.255/tilly-engineer-skills-0.3.255.zip",
    "docs/dist/0.3.255/tilly-engineer-skills-0.3.255.zip.sha256",
    ...
    "src/adapters/codex/skills/tes-goal-maestro/references/ambition-and-anchor.md",
    "src/adapters/codex/skills/tes-goal-maestro/references/execution-loop-runner.md",
    "src/adapters/codex/skills/tes-goal-maestro/references/execution-context-handoff.md",
    ...
    "src/adapters/codex/skills/tes-goal-maestro/references/runtime-certification.md",
    ...
    "src/adapters/codex/skills/tes-goal-maestro/references/tree-adversary.md",
    ...
    "src/adapters/claude/skills/tes-goal-maestro/references/ambition-and-anchor.md",
    "src/adapters/claude/skills/tes-goal-maestro/references/execution-loop-runner.md",
    "src/adapters/claude/skills/tes-goal-maestro/references/execution-context-handoff.md",
    ...
    "src/adapters/claude/skills/tes-goal-maestro/references/runtime-certification.md",
    ...
    "src/adapters/claude/skills/tes-goal-maestro/references/tree-adversary.md",
    ...
    "scripts/code_documentation_oracle.py",
    ...
    "scripts/staged_surface_check.py",
