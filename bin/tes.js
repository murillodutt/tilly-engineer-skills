...
function runtimeFailure(runtime) {
  ...
  console.error("  npx --loglevel=error -y --package github:murillodutt/tilly-engineer-skills#v0.3.99 tilly-engineer-skills add");
  console.error("  bunx --silent --bun --package github:murillodutt/tilly-engineer-skills#v0.3.99 tilly-engineer-skills add");
  return 1;
}
