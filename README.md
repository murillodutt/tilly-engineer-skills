...
[![Version](https://img.shields.io/badge/version-0.3.116-1f6feb)](package.json)
...
- Goal Maestro with `/tes-goal-maestro` for mature SPEC-to-execution-tree-to-`/goal` materialization.
